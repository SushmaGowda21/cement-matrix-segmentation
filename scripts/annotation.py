...
category_ids = {
    "cracks": 1,                 # Blue
    "cement_matrix": 2,          # Green
    "gravel_crushed_stones": 3,  # Red
    "air_pores": 4               # Magenta
}
MASK_EXT = 'png'
ORIGINAL_EXT = 'png' 
...
if __name__ == "__main__":
    train_mask_path = "data/augmented_data/train_masks/"
    train_json_path = "data/augmented_data/train_images/train.json"
    process_masks(train_mask_path, train_json_path)

    val_mask_path = "data/augmented_data/val_masks/"
    val_json_path = "data/augmented_data/val_images/val.json"
